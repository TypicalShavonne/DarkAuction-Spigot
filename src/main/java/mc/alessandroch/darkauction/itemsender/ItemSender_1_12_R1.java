...
public class ItemSender_1_12_R1 implements ItemSender{
	...
	public void createItm(ItemStack item,Location loc) {
		 ...
		 EntityItem_1_12_R1 entityItem = new EntityItem_1_12_R1(world.getHandle(),loc.getX(), loc.getY()+0.5, loc.getZ());
	...
	public void sendItem(Player player, ItemStack item,Location loc)
    {
       ...
       PacketEntityVelocity_1_12_R1 packet2 = new PacketEntityVelocity_1_12_R1(entityItem.getId(), new Vec3D(0, 0, 0) );
