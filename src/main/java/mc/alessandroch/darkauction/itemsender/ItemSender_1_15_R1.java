...
public class ItemSender_1_15_R1 implements ItemSender{
	...
	public void createItm(ItemStack item,Location loc) {
		 ...
		 CraftWorld world = (CraftWorld)loc.getWorld();
	        ...
	        EntityItem_1_15_R1 entityItem = new EntityItem_1_15_R1(world.getHandle(),loc.getX(), loc.getY()+0.5, loc.getZ());
	       ...
	       // entityItem.(true); //Set on ground not know class for 1.15-
		idd = entityItem;
	}
	@Override
